...
export const CONVERSION_ENDPOINTS = {
  ...
  "pdf-ofx": "/api/v1/convert/pdf/ofx",
  "xlsx-rubi": "/api/v1/convert/xlsx/rubi",
...
export const ENDPOINT_I18N: Record<string, [string, string]> = {
  ...
  "pdf-to-ofx": ["PDFToOFX.header", "PDF → OFX"],
  "xlsx-to-rubi": ["XLSXToRUBI.header", "Payroll sheet → RUBI TXT"],
...
export const TO_FORMAT_OPTIONS = [
  ...
  { value: "xlsx", label: "XLSX", group: "Spreadsheet" },
  { value: "ofx", label: "OFX", group: "Finance" },
  // GPS-Contadores: the FP-EVENTOS TXT that Sênior/RUBI imports, from the
  // payroll spreadsheet. Not a generic "xlsx → txt": the service only reads
  // the payroll department's layouts, hence the explicit label.
  { value: "rubi", label: "TXT RUBI (folha)", group: "Finance" },
  { value: "pptx", label: "PPTX", group: "Presentation" },
  { value: "odp", label: "ODP", group: "Presentation" },
  { value: "txt", label: "TXT", group: "Text" },
  { value: "rtf", label: "RTF", group: "Text" },
...
export const EXTENSION_TO_ENDPOINT: Record<string, Record<string, string>> = {
  ...
  doc: { pdf: "file-to-pdf" },
  odt: { pdf: "file-to-pdf" },
  xlsx: { pdf: "file-to-pdf", rubi: "xlsx-to-rubi" },
  xls: { pdf: "file-to-pdf" },
  ods: { pdf: "file-to-pdf" },
